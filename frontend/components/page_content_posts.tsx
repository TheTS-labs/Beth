...
function fetchPosts(
  ...
  fetch("https://localhost:8081/recommendation/getPosts", {
    ...
    body: body,
    redirect: 'follow'
  }).then((res => res.json() as Promise<GetPostsReturnType | RequestErrorObject>))
    .then(value => {
...
export default function PageContentPosts(props: Props): JSX.Element {
  ...
  useEffect(() => {
    const observer = new IntersectionObserver(
      entries => { if (entries[0].isIntersecting) { fetchPosts(afterCursor, setErrors, setAfterCursor, setPosts, showLoader); } },
      { threshold: 1 }
    );
        ...
        <div className={styles.post_container}>
          ...
          <div className={styles.voting}>
            <button className={styles.voting_button} data-type="dislike">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 14 14" onClick={() => {
